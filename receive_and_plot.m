...
s=serial('COM4');                      %creates a matlab object from the serial port 'COM1' 
...
for n = 1:number_of_samples             %get data and plot 
    ...
    %plot(my_time,raw_data,'b.-',my_time,filtered_data,'r-');
    axis([my_time(1) my_time(1)+simulation_time 0.0 3.3]);grid on;
    %axis([my_time(1) my_time(1)+simulation_time 2500 2600]);grid on;
